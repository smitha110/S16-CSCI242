...
namespace SimpleCompanyBundle\Controller;

use Symfony\Component\HttpFoundation\Request;
use Symfony\Bundle\FrameworkBundle\Controller\Controller;
use Sensio\Bundle\FrameworkExtraBundle\Configuration\Method;
use Sensio\Bundle\FrameworkExtraBundle\Configuration\Route;
use SimpleCompanyBundle\Entity\Company;
use SimpleCompanyBundle\Form\CompanyType;
...
class CompanyController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $companies = $em->getRepository('SimpleCompanyBundle:Company')->findAll();
    ...
    {
        $company = new Company();
        $form = $this->createForm('SimpleCompanyBundle\Form\CompanyType', $company);
    ...
    {
        $deleteForm = $this->createDeleteForm($company);
        $editForm = $this->createForm('SimpleCompanyBundle\Form\CompanyType', $company);
